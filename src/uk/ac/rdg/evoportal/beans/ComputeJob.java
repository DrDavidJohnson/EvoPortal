 ...
 * @author david
 */
public class ComputeJob implements IClusterable {
    private int jobID;
    ...
    public ComputeJob(int jobID, String label, int nodes, long submitTime, char status, long timeRequested, long timeUsed, String owner, long id) {
        this.jobID = jobID;
        this.label = label;
        this.nodes = nodes;
