 ...
 * @author david
 */
public final class ScaleTestComputeJobDetail extends AuthenticatedBasePage {
    ...
    public ScaleTestComputeJobDetail(PageParameters params) {
        String jobIDStr = params.getString("jobID");
        final int jobID = Integer.parseInt(jobIDStr);
        final ScaleTestComputeJob job = ScaleTestComputeJobsDataProvider.get(jobID);
        String testIDStr = params.getString("testID");
        final long testID = Long.parseLong(testIDStr);
        ...
        backLink.add(new Label("testID", Long.toString(testID)));
        add(backLink);
        add(new Label("id", jobIDStr));
    ...
    public ScaleTestComputeJobDetail() {
