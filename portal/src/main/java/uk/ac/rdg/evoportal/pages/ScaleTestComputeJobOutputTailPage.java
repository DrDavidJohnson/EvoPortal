 ...
 * @author david
 */
public final class ScaleTestComputeJobOutputTailPage extends AuthenticatedBasePage {

    transient Logger LOG = Logger.getLogger(ComputeJobOutputTailPage.class.getName());

    public ScaleTestComputeJobOutputTailPage(final int jobID, final long testID, final File file) {
        super();
        Link backLink = new Link("backLink") {
            @Override
            public void onClick() {
                setResponsePage(ScaleTestComputeJobDetail.class, new PageParameters("jobID=" + jobID + ",testID=" + testID));
            }
        };
