 ...
 * @author david
 */
public class ComputeJobOutputFilesDataView extends DataView {

    private int jobID;

    public ComputeJobOutputFilesDataView(String id, OutputFilesDataProvider dataProvider, int jobID) {
    ...
    protected void populateItem(Item item) {
        ...
        final TailLink tailLink = new TailLink("tailLink", file, jobID);
    ...
    private class TailLink extends Link {
        ...
        public TailLink(String id, File file, int jobID) {
            super(id);
            this.file = file;
            this.jobID = jobID;
        }
        ...
        @Override
        public void onClick() {
            setResponsePage(new ComputeJobOutputTailPage(jobID, file));
        }
    }
}
